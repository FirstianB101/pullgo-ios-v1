...
class AcademyAcceptStudentViewController: UICollectionViewController, IndicatorInfoProvider {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "AcademyAcceptStudentCell", for: indexPath) as? AcademyAcceptStudentCell else {
...
class AcademyAcceptStudentCell: UICollectionViewCell {
